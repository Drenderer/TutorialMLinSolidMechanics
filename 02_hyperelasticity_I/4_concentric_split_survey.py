...
plt.scatter(losses['splits'], losses['ICNN_train_avgs'], color=dh.colors['o3'], label = 'ICNN training loss')
plt.scatter(losses['splits'], losses['ICNN_test_avgs'], color=dh.colors['o5'], label = 'ICNN test loss')
plt.scatter(losses['splits'], losses['FFNN_train_avgs'], color=dh.colors['b2'], label = 'FFNN training loss')
plt.scatter(losses['splits'], losses['FFNN_test_avgs'], color=dh.colors['b4'], label = 'FFNN test loss')
